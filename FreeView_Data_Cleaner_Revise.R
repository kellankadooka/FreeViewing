...
for (folder in folders) {  
  ...
  write.table( df_eachvideo, file = (paste("~/Desktop/CLEANED_DATA/datacleaner/1_",parnum,".csv", sep ='')), sep = ",", col.names = FALSE, quote = FALSE, ) #Filename in the form "Video number_ participant ID.csv" ex 1_001.csv
  
  df_eachvideo <- read.csv((paste("~/Desktop/CLEANED_DATA/datacleaner/",folder,"/2 .csv", sep = "")), header=FALSE)
  value <- df_eachvideo$V6[1]
  df_eachvideo$V6 <- df_eachvideo$V6 - value
  df_eachvideo$V1 <- NULL
  write.table( df_eachvideo, file =  (paste("~/Desktop/CLEANED_DATA/datacleaner/2_",parnum,".csv", sep ='')), sep = ",", col.names = FALSE, quote = FALSE, )
  
  df_eachvideo <- read.csv((paste("~/Desktop/CLEANED_DATA/datacleaner/",folder,"/3 .csv", sep = "")), header=FALSE)
  value <- df_eachvideo$V6[1]
  df_eachvideo$V6 <- df_eachvideo$V6 - value
  df_eachvideo$V1 <- NULL
  write.table( df_eachvideo, file =  (paste("~/Desktop/CLEANED_DATA/datacleaner/3_",parnum,".csv", sep ='')), sep = ",", col.names = FALSE, quote = FALSE, )
  
  df_eachvideo <- read.csv((paste("~/Desktop/CLEANED_DATA/datacleaner/",folder,"/4 .csv", sep = "")), header=FALSE)
  value <- df_eachvideo$V6[1]
  df_eachvideo$V6 <- df_eachvideo$V6 - value
  df_eachvideo$V1 <- NULL
  write.table( df_eachvideo, file =  (paste("~/Desktop/CLEANED_DATA/datacleaner/4_",parnum,".csv", sep ='')), sep = ",", col.names = FALSE, quote = FALSE,)
  
  df_eachvideo <- read.csv((paste("~/Desktop/CLEANED_DATA/datacleaner/",folder,"/5 .csv", sep = "")), header=FALSE)
  value <- df_eachvideo$V6[1]
  df_eachvideo$V6 <- df_eachvideo$V6 - value
  df_eachvideo$V1 <- NULL
  write.table( df_eachvideo, file =  (paste("~/Desktop/CLEANED_DATA/datacleaner/5_",parnum,".csv", sep ='')), sep = ",", col.names = FALSE, quote = FALSE, )
  
  df_eachvideo <- read.csv((paste("~/Desktop/CLEANED_DATA/datacleaner/",folder,"/6 .csv", sep = "")), header=FALSE)
  value <- df_eachvideo$V6[1]
  df_eachvideo$V6 <- df_eachvideo$V6 - value
  df_eachvideo$V1 <- NULL
  write.table( df_eachvideo, file =  (paste("~/Desktop/CLEANED_DATA/datacleaner/6_",parnum,".csv", sep ='')), sep = ",", col.names = FALSE, quote = FALSE, )
  
  df_eachvideo <- read.csv((paste("~/Desktop/CLEANED_DATA/datacleaner/",folder,"/7 .csv", sep = "")), header=FALSE)
  value <- df_eachvideo$V6[1]
  df_eachvideo$V6 <- df_eachvideo$V6 - value
  df_eachvideo$V1 <- NULL
  write.table( df_eachvideo, file =  (paste("~/Desktop/CLEANED_DATA/datacleaner/7_",parnum,".csv", sep ='')), sep = ",", col.names = FALSE,quote = FALSE, )
  #
